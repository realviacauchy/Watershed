...
Rename columns for consistency with African data columns. Remove splcing_pvalue and ase_pvalue columns
```{r prepare_data}
...
euro_data_all="/scratch/groups/abattle4/victor/GTExV8_RareVariationData/RIVER/river_input_v8_european_all_06-09-2020.txt"
Rscript evaluate_watershed.R --input $euro_data_all --number_dimensions 1 --output_prefix "/scratch/groups/abattle4/victor/GTExV8_RareVariationData/RIVER/eval_euro_all" --model_name RIVER
```
